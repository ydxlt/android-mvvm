...
import org.yzjt.sdk.base.BaseMultiRecyclerAdapter;
 ...
 */
public abstract class BaseListFragment<T extends IContract.Presenter,D extends List> extends LazyMvpFragment<T> implements IContract.View, RequestCallback<D>, LoadingListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private int mPage = 1;
    private BaseMultiRecyclerAdapter mBaseRecyclerAdapter;
    ...
    protected abstract BaseMultiRecyclerAdapter getRecyclerAdapter();
